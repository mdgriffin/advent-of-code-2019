...
public class AsteroidMonitoringStationLocatorTest {
	...
	public void isOnPath() {
		assertTrue(AsteroidMonitoringStationLocator.isOnPath(new MapPosition(0, 0), new MapPosition(0, 0),
				new MapPosition(0, 0)));
		assertTrue(AsteroidMonitoringStationLocator.isOnPath(new MapPosition(0, 0), new MapPosition(9, 9),
				new MapPosition(8, 8)));
	}
	...
	public void getDistance() {
		assertEquals(11.18d,
				AsteroidMonitoringStationLocator.getDistance(new MapPosition(-5, -5), new MapPosition(0, 5)), 5);
		assertEquals(26d, AsteroidMonitoringStationLocator.getDistance(new MapPosition(-7, -4), new MapPosition(17, 6)),
				5);
	}
	...
	public void getAngle() {
		assertEquals(0d, AsteroidMonitoringStationLocator.getAngle(new MapPosition(5, 5), new MapPosition(5, 2)), 3);
		assertEquals(5.194d, AsteroidMonitoringStationLocator.getAngle(new MapPosition(11, 13), new MapPosition(12, 1)),
				3);
		assertEquals(45d, AsteroidMonitoringStationLocator.getAngle(new MapPosition(5, 5), new MapPosition(8, 2)), 3);
		assertEquals(90d, AsteroidMonitoringStationLocator.getAngle(new MapPosition(5, 5), new MapPosition(8, 5)), 3);
		assertEquals(135d, AsteroidMonitoringStationLocator.getAngle(new MapPosition(5, 5), new MapPosition(8, 8)), 3);
		assertEquals(180d, AsteroidMonitoringStationLocator.getAngle(new MapPosition(5, 5), new MapPosition(5, 8)), 3);
		assertEquals(225d, AsteroidMonitoringStationLocator.getAngle(new MapPosition(5, 5), new MapPosition(2, 8)), 3);
		assertEquals(270d, AsteroidMonitoringStationLocator.getAngle(new MapPosition(5, 5), new MapPosition(3, 5)), 3);
		assertEquals(315d, AsteroidMonitoringStationLocator.getAngle(new MapPosition(5, 5), new MapPosition(2, 2)), 3);
		assertEquals(153.434d,
				AsteroidMonitoringStationLocator.getAngle(new MapPosition(11, 13), new MapPosition(12, 15)), 3);
		assertEquals(116.565d,
				AsteroidMonitoringStationLocator.getAngle(new MapPosition(11, 13), new MapPosition(13, 14)), 3);
	}
